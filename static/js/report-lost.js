// Report Lost Item functionality with Flask API
const API_URL = '/api';
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (!userData) {
        showToast('You must be logged in to report a lost item', 'error');
        setTimeout(() => {
...
function validateForm() {
    const requiredFields = ['itemName', 'category', 'description', 'location', 'dateLost', 'contactInfo'];
    let isValid = true;
